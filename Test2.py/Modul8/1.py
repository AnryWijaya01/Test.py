...
comboPilihOperator = ttk.Combobox(root, values=["+","-","*","/"], textvariable=nanaCbBox)
conboPilihOperator.grid(row=1, column=0, padx=(5,0), pady=(9,5))

# © artinya menampilkan value pertama ComboBox yaitu simbol TAMBAH (+)
conboPilihOperator. current (0)
...
tombolTampil.configure(bg="4090", fg="#FFF")
